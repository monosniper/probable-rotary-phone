...
const InteracPay = ({ amount, submit, setCurrent }) => {
...
const ColdPay = ({ setCurrent, submit }) => {
    ...
    return <>
        ...
        <div className="foot">
            ...
            <Button onClick={() => setCurrent('crypto')} className="pink-btn btn-lg rounded">{t('pay_crypto')}</Button>
            <Button onClick={() => setCurrent('card')} className="pink-btn btn-lg rounded">{t('pay_interac')}</Button>
        </div>
    </>
}
...
const PushMoney = () => {
    ...
    const contents = {
        ...
        'interac': <InteracPay amount={amount} setCurrent={setCurrent} submit={submitCard} />,
