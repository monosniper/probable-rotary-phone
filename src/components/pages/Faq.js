...
const Faq = () => {
            ...
            questions: [
                {
                    ...
                    answer: 'Чтобы зарегистрироваться в «Космолот», необходимо нажать на кнопку «Регистрация за 10 секунд» в верхнем правом углу сайта.\n' +
                        '\n' +
                ...
                },
                {
                    ...
                    answer: 'На сайте «Космолот» вы можете открыть только один счет.\n' +
                        '\n' +
    ...
    3.  «Сайт загружается, но вход в аккаунт не происходит». Попробуйте открыть новую вкладку браузера в режиме «Инкогнито» и перейти по ссылке https://cosmolot.ua/`
                },
                {
...
Информацию о бонусах вы можете найти:
  ...
  •  В Telegram-канале t.me/cosmolot;
  •  В чат-боте t.me/cosmolot_promo_bot;
...
Как только вы поймете, что к чему – добро пожаловать в «Космолот»! Большие призы зовут, и мы искренне желаем вам удачи!`
                },
                {
...
Если после выполнения этих рекомендаций в игре продолжают возникать неполадки, пожалуйста, обратитесь в онлайн-чат нашей службы поддержки. Также вы также можете обратиться на почту: support@cosmolot.ua В обращении необходимо выслать:
            ...
            questions: [
                {
                    ...
                    answer: `Спортивный Квест - это новый способ выиграть награды в казино на сайте Cosmolot. Ответьте на простые вопросы о Ваших любимых игроков, спортивные события и матчи и получите возможность выиграть до 25 000 бонусных средств в казино.`
                },
                {
