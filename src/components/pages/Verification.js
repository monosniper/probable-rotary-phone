...
const Verification = () => {
    ...
    return (
        <div className="verification">
            ...
            <p>Makao777 первая площадка с различными играми которая предоставляет возможность играть сразу - без прохождения верификации. Мы ценим время каждого нашего посетителя и не желаем тратить его время на прохождение верификации пользователя. Также это увеличивает безопасность соединения поскольку Ваши данные нигде не сохраняются и не обрабатываются.</p>
